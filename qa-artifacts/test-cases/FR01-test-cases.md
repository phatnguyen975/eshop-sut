...
| ------------ | ---- | --------------------------- | -------------------------------- | ---------------- | ------ |
| FR01-EP-001  | EP   | EC01+EC04+EC11+EC20+EC23    | Happy path — all valid           | UI + API + State |        |
| FR01-EP-002  | EP   | EC02                        | Empty name                       | UI + API         |        |
| FR01-EP-003  | EP   | EC03                        | Null/missing name (API)          | API              |        |
| FR01-EP-004  | EP   | EC05                        | Invalid email: no @              | UI + API         |        |
| FR01-EP-005  | EP   | EC06                        | Invalid email: no domain         | UI + API         |        |
| FR01-EP-006  | EP   | EC07                        | Invalid email: no local part     | UI + API         |        |
| FR01-EP-007  | EP   | EC08                        | Duplicate email (DB state)       | UI + API         |        |
| FR01-EP-008  | EP   | EC09                        | Empty email                      | UI + API         |        |
| FR01-EP-009  | EP   | EC10                        | Null/missing email (API)         | API              |        |
| FR01-EP-010  | EP   | EC12                        | Password < 8 chars               | UI + API         |        |
| FR01-EP-011  | EP   | EC13                        | Password: no uppercase           | UI + API         |        |
| FR01-EP-012  | EP   | EC14                        | Password: no lowercase           | UI + API         |        |
| FR01-EP-013  | EP   | EC15                        | Password: no digit               | UI + API         |        |
| FR01-EP-014  | EP   | EC16                        | Password: no special char        | UI + API         |        |
| FR01-EP-015  | EP   | EC17                        | Password: char outside `@$!%*?&` | UI + API         |        |
| FR01-EP-016  | EP   | EC18                        | Empty password                   | UI + API         |        |
| FR01-EP-017  | EP   | EC19                        | Null/missing password (API)      | API              |        |
| FR01-EP-018  | EP   | EC21                        | ConfirmPassword != password      | UI               |        |
| FR01-EP-019  | EP   | EC22                        | Empty confirmPassword            | UI               |        |
| FR01-EP-020  | EP   | EC24                        | XSS payload in name (SEC-04)     | UI + DOM + State |        |
| FR01-BVA-001 | BVA  | password −α (0 chars)       | Empty password                   | API              |        |
| FR01-BVA-002 | BVA  | password LB−1 (7 chars)     | Password one below minimum       | UI + API         |        |
| FR01-BVA-003 | BVA  | password LB (8 chars)       | Password exact minimum           | UI + API + State |        |
| FR01-BVA-004 | BVA  | password LB+1 (9 chars)     | Password one above minimum       | API + State      |        |
| FR01-BVA-005 | BVA  | password Nominal (15 chars) | Password nominal length          | API + State      |        |
| FR01-BVA-006 | BVA  | password +α (300 chars)     | Password absolute maximum        | API              |        |
| FR01-BVA-007 | BVA  | name −α/LB−1 (0 chars)      | Empty name                       | API              |        |
| FR01-BVA-008 | BVA  | name LB (1 char)            | Name exact minimum               | API + State      |        |
| FR01-BVA-009 | BVA  | name LB+1 (2 chars)         | Name one above minimum           | API + State      |        |
| FR01-BVA-010 | BVA  | name Nominal (12 chars)     | Name nominal length              | API + State      |        |
| FR01-BVA-011 | BVA  | name UB−1 (254 chars)       | Name one below DB limit          | API + State      |        |
| FR01-BVA-012 | BVA  | name UB (255 chars)         | Name at DB VARCHAR limit         | API + State      |        |
| FR01-BVA-013 | BVA  | name UB+1 (256 chars)       | Name above DB limit              | API              |        |
| FR01-BVA-014 | BVA  | name +α (500 chars)         | Name absolute maximum            | API              |        |
| FR01-BVA-015 | BVA  | email Nominal (16 chars)    | Email nominal length             | API + State      |        |
| FR01-BVA-016 | BVA  | email UB (255 chars)        | Email at DB VARCHAR limit        | API + State      |        |
| FR01-BVA-017 | BVA  | email UB+1 (256 chars)      | Email above DB limit             | API              |        |
| FR01-BVA-018 | BVA  | email +α (300 chars)        | Email absolute maximum           | API              |        |
